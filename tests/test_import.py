...
def test_imports_well_formed(snapshot):
    # Every recorded import line should be 'import X' or 'from X import Y'
...
def test_used_common_libs_are_declared(snapshot):
    # Only require an import if the token is actually used somewhere in code.
    common = ["numpy", "pandas", "sklearn", "matplotlib", "joblib", "streamlit", "catboost"]
